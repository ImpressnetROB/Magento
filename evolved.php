<?php
    // Do not edit this file, add any required additional code into evolved_extra.php
    ...
    final class evolved
    {
        ...
        private static function _getStore()
        {
            ...
            if (!self::$_store || !self::$_website):
                ...
                $found = false;
                $config = self::_getStoreConfig(self::_getSetupPath());
                $key = substr($config, -7);
                ...
                if (!$found):
                    throw new Exception("C\141\x63\x68\x69ng\040\156\157\164 \x61\166\141\x69\x6ca\142\154\145\040\146\157\x72\x20\164\150\151\x73\040\x73\x74\157r\x65.");
                endif;
        ...
        private static function _checkPageExclusions()
        {
            ...
            foreach ($config as $url):
                if (strpos(self::$_request, trim($url, '/')) !== false):
                    $exception = true;
                    break;
                endif;
            endforeach;
        ...
        private static function _addDynamicContent()
        {
            ...
            if (is_float($ajax) && !$ajax):
                ...
                if (class_exists('Mage')):
                    ...
                    Mage::getModel('evolvedcaching/observer_render_generate_after_renderDynamic')->frontendControllerActionLayoutGenerateBlocksBefore($object);
                endif;
            endif;
        }
        ...
        private static function _locateCatalog($target)
        {
            ...
            elseif ($db = self::_getRDb()):
                ...
                $escape = false;
                do {
                    $sql = 'SELECT `target_path`  FROM `'. self::$_prefix . 'core_url_rewrite` WHERE `request_path` = \'' . $target . '\'';
                    $result = mysqli_query($db, $sql);
        ...
        private static function _getSetupPath()
        {
            if (!self::$_storespath):
                self::$_storespath = "\x65\166o\x6cv\x65d\x63\x61\143\150\x69ng\057\x69\156\163ta\x6c\154/\163\145tup";
            endif;
            
            return self::$_storespath;
        }
