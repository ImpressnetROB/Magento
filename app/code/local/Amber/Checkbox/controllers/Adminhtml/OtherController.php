...
class Amber_Checkbox_Adminhtml_OtherController extends Mage_Adminhtml_Controller_Action
{
	public function indexAction()
	{

		$this->loadLayout();
		$favourites = 'Other brands';
		...
		$this->_addLeft($this->getLayout()->createBlock('core/text')->setText("Other"));
